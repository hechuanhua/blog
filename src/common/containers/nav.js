...
class Nav extends Component {
    ...
    render() {
        ...
        return <div className = "Head" >
            < div className = "topTips" > { isLogin } < /div> < div className = "logo content" > < a href = "/" > 我的个人网站 < /a> < form className = "searchForm" > < input type = "text" ref = { el => { this.keyword = el } } name = "keyword" placeholder = "可以搜标题或者内容" / >
            < div className = "btn" onClick = { () => { this.handleSubmit() } } > 提交 < /div> < /form> < /div> < /div>
    }
}
