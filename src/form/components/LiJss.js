...
export const LiJss=({onclick})=>{
    return( 
        <li onClick={()=>{onclick("JSS")}}><i className="iconfont icon-jisuangongshipeizhi"></i>计算式</li>
    )
}
export const PreviewJss=({data,actions})=>{
...
export class EditJss extends Component{
    ...
    return <div className="fieldEdit textFieldEdit">
             <div className="title"><i className="fa fa-edit"></i>计算式</div>
