...
export const LiMobile=({onclick})=>{
    return( 
      <li onClick={()=>{onclick("MOBILE")}}><i className="iconfont icon-shouji"></i>手机</li>
    )
}
export const PreviewMobile=({data,actions})=>{
...
export class EditMobile extends Component{
    ...
    return <div className="fieldEdit textFieldEdit">
             <div className="title"><i className="fa fa-edit"></i>手机号码</div>
