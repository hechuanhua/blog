...
export const LiPic=({onclick})=>{
    return( 
      <li onClick={()=>{onclick("PIC")}}><i className="iconfont icon-tupian"></i>图片</li>
    )
}
export const PreviewPic=({data,actions})=>{
...
export class EditPic extends Component{
    ...
    return <div className="fieldEdit textFieldEdit">
             <div className="title"><i className="fa fa-edit"></i>图片</div>
