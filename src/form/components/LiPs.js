...
export const LiPs=({onclick})=>{
    return( 
        <li onClick={()=>{onclick("PS")}}><i className="iconfont icon-shuoming"></i>说明项</li>
    )
}
export const PreviewPs=({data,actions})=>{
    return <div className={data.active?"previewItem active":"previewItem"} onClick={()=>{actions.clickPreviewLi(data.id)}}>
              ...
              <div className="readOnly">{data.tis}</div>
...
export class EditPs extends Component{
    ...
    return <div className="fieldEdit textFieldEdit">
             <div className="title"><i className="fa fa-edit"></i>说明项</div>
