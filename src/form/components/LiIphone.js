...
export const LiIphone=({onclick})=>{
    return( 
      <li onClick={()=>{onclick("IPHONE")}}><i className="iconfont icon-dianhua"></i>电话</li>
    )
}
  var field=['单行文字','多行文字','单项选择','多项选择','下拉框','数字','邮箱','电话','地理位置','时间','评分','微信扫码','子表单'];
export const PreviewIphone=({data,actions})=>{
...
export class EditIphone extends Component{
    ...
    return <div className="fieldEdit textFieldEdit">
             <div className="title"><i className="fa fa-edit"></i>电话号码</div>
