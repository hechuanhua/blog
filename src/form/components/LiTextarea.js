...
export const LiTextarea=({onclick})=>{
    return(
        <li onClick={()=>{onclick("TEXTAREA")}}><i className="iconfont icon-duoxingwenzi"></i>多行文字</li>
    )
}
export const PreviewTextarea=({data,actions})=>{
             ...
             <div className="edit_item">   
               ...
               <div className="write">     
                   <ul>     
                       ...
                       <li className=""><label className="checkbox"><input type="checkbox" ref={el=>{readonly=el}} 
                       onChange={()=>{actions.changeValue("readonly",readonly.checked,data.id)}} checked={data.readonly}/>只读项</label></li>     
                       <li>
