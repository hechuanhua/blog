...
export const LiFujian=({onclick})=>{
    return( 
      <li onClick={()=>{onclick("FUJIAN")}}><i className="iconfont icon-fujian"></i>附件</li>
    )
}
export const PreviewFujian=({data,actions})=>{
...
export class EditFujian extends Component{
    ...
    return <div className="fieldEdit textFieldEdit">
             <div className="title"><i className="fa fa-edit"></i>附件</div>
